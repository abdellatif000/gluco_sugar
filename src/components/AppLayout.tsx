...
export function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  if (authState === 'loading' || authState === 'loggedOut' || !user) {
    return (
  ...
  return (
    <div className="grid min-h-screen w-full md:grid-cols-[220px_1fr] lg:grid-cols-[280px_1fr]">
      <div className="hidden border-r bg-glass md:block">
      ...
      <div className="flex flex-col bg-transparent">
        <header className="flex h-14 items-center gap-4 border-b bg-glass px-4 lg:h-[60px] lg:px-6">
          <Sheet>
            ...
            <SheetContent side="left" className="flex flex-col p-0 bg-glass">
